          ...
          <Row className="justify-content-center text-center">
            <Col lg="12">
              <h1 className="display-4 text-white fw-bold mb-4">
                We help young athletes who struggle with doubt, fear, and negative
                thoughts by giving them tools to handle physical, psychological,
                and emotional stress in youth sports.
              </h1>
              ...
              <div className="d-flex justify-content-center gap-3">
                ...
                <Link href="/indoor" passHref legacyBehavior>
